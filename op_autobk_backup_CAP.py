...
<request id="G1000" origin="gui" destination="device" command="add" category="login" time="{}" protocol-version="5.0" platform-name="CAP-1000" type="push">
	<user name="{}" password="{}" authentication="embedded" />
</request>
"""
sCapRpcBackup = """\
<?xml version="1.0" encoding="UTF-8"?>
<request id="G1001" origin="gui" destination="device" command="update" category="config" time="{0}" protocol-version="5.0" platform-name="CAP-1000" sid="{1}">
	<path>
		<manager id="{2}" />
		<farmer id="{2}" />
	</path>
...
sCapRpcErase = """\
<?xml version="1.0" encoding="UTF-8"?>
<request id="G1002" origin="gui" destination="device" command="remove" category="file" time="{0}" protocol-version="5.0" platform-name="CAP-1000" sid="{1}">
	<path>
		<manager id="{2}" />
		<farmer id="{2}" />
	</path>
...
sCapRpcLogoff = """\
<?xml version="1.0" encoding="UTF-8"?>
<request id="G1003" origin="gui" destination="device" command="remove" category="login" time="{}" protocol-version="5.0" platform-name="CAP-1000" sid="{}" />
"""
dnRpcHdrsCAP = {
